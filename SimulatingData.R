...
parameters <- c("phi.mean", "p.mean","beta.t","beta.sp","beta.tXsp")
...
cjs.interaction <- jags(jags.data, inits, parameters, "cjs-phi(spXt)p(.).jags",
                        n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb, working.directory = getwd())
print(cjs.interaction, digits = 3)
